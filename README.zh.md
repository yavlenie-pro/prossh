...
![ProSSH：带标签的 SSH 会话，SFTP 面板与终端并排显示](docs/screenshots/terminal-tabs.png)
...
| 平台 | 构件 |
| --- | --- |
| Windows | `ProSSH_*_x64-setup.exe`（NSIS，多语言 —— EN / RU / ZH）、`ProSSH_*_x64_en-US.msi`、`_ru-RU.msi`、`_zh-CN.msi` |
